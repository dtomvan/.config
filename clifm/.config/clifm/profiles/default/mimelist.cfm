...
X:(^text/.*|application/json|inode/x-empty)=nvim;micro;nano;vim;vi;emacs;ed;leafpad;mousepad;kate;gedit;pluma
!X:(^text/.*|application/json|inode/x-empty)=nvim;micro;nano;vim;vi;emacs;ed
...
# Video and audio
X:^video/.*=mpv;ffplay;mplayer;mplayer2;mpv;vlc;gmplayer;smplayer;totem
X:^audio/.*=mpv;ffplay -nodisp -autoexit;mplayer;mplayer2;mpv;vlc;gmplayer;smplayer;totem
