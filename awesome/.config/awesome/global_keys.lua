...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "j",
              ...
              {description = "increase layout number for current tag", group = "tag"}
    ),
    awful.key({ modkey, "Control" }, "k",
              ...
              {description = "decrease layout number for current tag", group = "tag"}
    ),
    ...
    awful.key({ modkey }, "n",
              function ()
                  awful.client.focus.minimized = true
              end,
              {description = "minimize current client", group = "client"}),
